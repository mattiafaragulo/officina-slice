...
const PIZZE = [
  ...
  { num:2,  name:"Salame",              nameEN:"Salami",
    desc:"Pomodoro, fior di latte, salame dolce",
  ...
  { num:5,  name:"Zucca, Guanciale & Mozzarella", nameEN:"Pumpkin, Guanciale & Mozzarella",
    ...
    descEN:"Pumpkin cream, guanciale, mozzarella, smoked cherry tomatoes",
    trancio:"€2,00", mezza:"€11,50", teglia:"€20,00", cat:"special", special:true },
  { num:6,  name:"Speck",               nameEN:"Speck",
  ...
  { num:12, name:"Spianata Piccante", nameEN:"Spicy Stracchino",
    desc:"Datterino giallo, stracchino piccante, stracciatella di bufala",
    descEN:"Yellow cherry tomato, spicy stracchino, buffalo stracciatella",
  ...
  { num:15, name:"Crema Pistacchio",    nameEN:"Pistachio Cream",
    desc:"Crema di pistacchio, fior di latte, ingredienti selezionati",
    descEN:"Pistachio cream, mozzarella, selected toppings",
    trancio:"€2,50", mezza:"€15,00", teglia:"€25,00", cat:"special", special:true },
  { num:16, name:"Crema Parmigiano",    nameEN:"Parmesan Cream",
    desc:"Crema di parmigiano, ingredienti selezionati",
    descEN:"Parmesan cream, selected toppings",
    trancio:"€2,50", mezza:"€15,00", teglia:"€25,00", cat:"special" },
  { num:17, name:"Mascarpone",          nameEN:"Mascarpone",
...
const DRINKS = [
  ...
  { name:"Midori Sour",
    ...
    price:"€5" },
  { name:"Cosmopolitan",
    ingredients:"Vodka, Triple Sec, Cramberry, Lime · Dec: Peel Arancia",
    price:"€5" },
  { name:"Capirinha",
  ...
  { name:"Sex on the Beach",
    ingredients:"Vodka, Peach, Arancia, Cramberry · Dec: Zest Arancia",
    price:"€5" },
  ...
  { name:"Negroni Sbagliato",
    ...
    price:"€5" },
  { name:"Negroni",
    ingredients:"Gin Tanqueray, Vermuth Rosso, Campari Bitter · Dec: Zest Arancia",
    price:"€6" },
  { name:"Moscow Mule",
